...
layout: "post"
title: "Ods rtf显示特殊字符"
date: "2019-07-04 23:04"
---
### rtf格式如何显示特殊字符

#### 特殊字符的unicode查看
在创建特殊字符之前，我们需要知道每个特殊字符的相应unicode。我们可以通过使用Microsoft Word来实现这一点。单击“ 插入”选项卡 ->“ 符号” - >“其它符号” 以确定字符的unicode。如果单击任何符号，则可以看到此符号的unicode将出现在“ 符号”对话框的右下角。例如，正负号的unicode是00B1。
